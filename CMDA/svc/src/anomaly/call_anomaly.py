...
class call_service:
    def __init__(self, pFile):
        ...
        len1 = len(args)
        if len1 != (7 + 3*self.nVar):
          print 'number of arguments is not right!!'
          return
        ...
        for iVar in range(self.nVar):
          ...
          ii += 1
          self.vars1.append(args[ii])
          ii += 1
          self.pres1.append(args[ii])
...
if __name__ == '__main__':
    ...
    c1 = call_service(\
         ...
         'ukmo_hadgem2-a', 'clt', '200', 
         '0', '100', '-29', '29', \
         '/home/svc/cmac/trunk/services/svc/svc/static/conditionalPdf')
